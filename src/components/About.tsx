      ...
      <div className="section-container">
        ...
        <div className="max-w-3xl">
          <p className="text-lg text-muted-foreground leading-relaxed mb-6">
            I’m a final‑year B.Sc. Computer Science student and entry‑level software developer with a strong foundation in Python and a genuine interest in building backend systems that work. My focus is on backend development, machine learning applications, and exploring how LLMs can be integrated into practical workflows.
          </p>
